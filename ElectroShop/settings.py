...
SECRET_KEY = 'django-insecure-2n)_p-cja(7ij6n&l!)*rjw&j-q3wm=(o3@wtnkygks78dtanv'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # ✅ Correct and placed at the top
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIMER': timedelta(days=1)
}
